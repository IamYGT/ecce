													...
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																...
																<input type="text" name="haber_aciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Açıklama" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Adresi</label>
																<input type="text" name="haber_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder=" Adresi" required="">
															</div>
														</div>  
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Açıklama</label>
																<input type="text" name="haber_aciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Açıklama" required="" value="<?php echo GetTableValue("haber_aciklama",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Adres</label>
																<input type="text" name="haber_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Adres" required="" value="<?php echo GetTableValue("haber_kisaaciklama",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div> 
													</div>
													<input type="hidden" name="form_<?php echo $LANGUAGE_CODE; ?>" value="<?php echo $LANGUAGE_CODE; ?>" />
